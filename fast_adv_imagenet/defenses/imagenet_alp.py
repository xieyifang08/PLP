...
parser.add_argument('--save-folder', '--sf', default='weights/imagenet100_wrn_alp/',
                    help='folder to save state dicts')
parser.add_argument('--visdom_env', '--ve', type=str, default="imagenet100_wrn_alp")
parser.add_argument('--report_msg', '--rm', type=str, default="imagenet100_wrn_baseline, alp实验")
...
weight = "./weights/imagenet100_wrn_baseline/best_imagenet100_ep_76_val_acc0.7773.pth"
...
for epoch in range(args.epochs):
    ...
    for batch_data in tqdm.tqdm(train_loader):
        ...
        if args.adv is not None and epoch >= args.adv:
            ...
            loss = loss + loss_adv + 0.2*F.mse_loss(logits_adv, logits)
