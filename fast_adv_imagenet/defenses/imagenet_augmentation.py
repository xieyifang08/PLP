...
from fast_adv_imagenet.process.jpeg_compression import JpegCompression
...
parser.add_argument('--save-folder', '--sf', default='weights/wide_resnet101_at_jpeg/', help='folder to save state dicts')
parser.add_argument('--visdom_env', '--ve', type=str, default="wide_resnet101_at_jpeg",
