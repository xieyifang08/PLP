...
parser.add_argument('--save-folder', '--sf', default='weights/imagenet100_anl_block34_only_rerun3',
                    help='folder to save state dicts')
parser.add_argument('--visdom_env', '--ve', type=str, default="imagenet100_anl_block34_only_rerun3")
parser.add_argument('--report_msg', '--rm', type=str, default="imagenet100上的anl模型 block34 rerun3")
...
model = model_utils.load_model("imagenet100_wide_resnet101_anl_block34", pretrained=False, num_classes=100).to(DEVICE)
