...
parser.add_argument('--save-folder', '--sf', default='weights/imagenet100_wide_resnet101_dfp_fp_2/',
                    help='folder to save state dicts')
parser.add_argument('--visdom_env', '--ve', type=str, default="imagenet100_wide_resnet101_dfp_fp_2")
parser.add_argument('--report_msg', '--rm', type=str, default="imagenet100上的dfp实验，dfp_fp")
...
model = model_utils.load_model("imagenet100_wide_resnet101_dfp_fp", pretrained=False, num_classes=100).to(DEVICE)
...
# weight = "./weights/imagenet100_dfp_replace_conv1_ap/best_imagenet100_ep_49_val_acc0.7849.pth"  # imagenet100_wide_resnet101_dfp_replace_conv1
...
if args.adv == 0:
    ...
    scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[30, 80, 120], gamma=0.1)
...
send_email("{}\n visdom is: {}\nval acc is: {}".format(args.report_msg,
                                                       CALLBACK.get_visodom_address() if args.visdom_available else None,
                                                       str(valacc_final)))
