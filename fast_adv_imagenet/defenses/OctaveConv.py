...
import fast_adv_imagenet.models as models
...
parser.add_argument('-a', '--arch', metavar='ARCH', default='octave_resnet50',
                    choices=model_names,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_loader = load_data(os.path.join(args.data, 'dev.csv'), os.path.join(args.data, 'images'))['dev_data']
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, batch_data in enumerate(train_loader):
        input, target, filenames = batch_data['image'], batch_data['label_idx'], \
                                          batch_data['filename']
