...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.window = window
        self.channel = 256*4
        self.query_conv = nn.Conv2d(in_channels=self.channel, out_channels=self.channel // 8, kernel_size=1)
        self.key_conv = nn.Conv2d(in_channels=self.channel, out_channels=self.channel // 8, kernel_size=1)
        self.value_conv = nn.Conv2d(in_channels=self.channel, out_channels=self.channel, kernel_size=1)
